...
음악의 장르, 아티스트 등 메타데이터를 활용해 기록을 정리하여, 또한 어떤 아티스트, 트랙, 앨범을 주로 들었는지, 월별 청취 기록 등과 같은 데이터 통계를 제공하여 사용자가 자신의 음악 취향과 패턴을 한눈에 파악할 수 있도록 한다.<br>
...
- **Dynamics**: 시스템은 기록 데이터를 집계하여 아티스트별, 트랙별, 앨범별, 월별 통계를 계산하고 이를 사용자에게 제공한다
